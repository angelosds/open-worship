...
const Logo = ({ className }) => (
  <svg className={className} viewBox="0 0 59 59" fill="none">
    ...
    <S.Rect x="34.9515" y="17.9749" width="4" height="30" rx="2" transform="rotate(-45 34.9515 17.9749)" />
    <S.Rect x="5.94788" y="18.682" width="4" height="30" rx="2" transform="rotate(-45 5.94788 18.682)" />
  </svg>
);
